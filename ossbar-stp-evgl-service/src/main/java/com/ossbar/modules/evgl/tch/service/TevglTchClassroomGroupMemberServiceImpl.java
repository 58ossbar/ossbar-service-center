...
public class TevglTchClassroomGroupMemberServiceImpl implements TevglTchClassroomGroupMemberService {
	...
	public R save(@RequestBody(required = false) TevglTchClassroomGroupMember tevglTchClassroomGroupMember) throws OssbarException {
	...
	public R update(@RequestBody(required = false) TevglTchClassroomGroupMember tevglTchClassroomGroupMember) throws OssbarException {
	    ValidatorUtils.check(tevglTchClassroomGroupMember);
