...
public class TevglForumFriendTypeServiceImpl implements TevglForumFriendTypeService {
	...
	public R save(@RequestBody(required = false) TevglForumFriendType tevglForumFriendType) throws OssbarException {
	...
	public R update(@RequestBody(required = false) TevglForumFriendType tevglForumFriendType) throws OssbarException {
	    ValidatorUtils.check(tevglForumFriendType);
