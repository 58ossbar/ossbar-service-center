...
public class TevglActivitySigninInfoServiceImpl implements TevglActivitySigninInfoService {
	...
	public R save(@RequestBody(required = false) TevglActivitySigninInfo tevglActivitySigninInfo) throws OssbarException {
	...
	public R update(@RequestBody(required = false) TevglActivitySigninInfo tevglActivitySigninInfo) throws OssbarException {
	...
	public R saveSigninInfo(@RequestBody TevglActivitySigninInfo tevglActivitySigninInfo, String pkgId, String loginUserId) throws OssbarException {
	...
	public R deleteSigninInfo(String activityId, String pkgId, String loginUserId) throws OssbarException {
	...
	public R queryHistorySigninInfo(@RequestParam Map<String, Object> params) {
		...
		list.stream().forEach(info -> {
			if (info.get("createTime") != null) {
				...
				// 计算创建日期处于星期几
				String val = DateUtil.getDayOfWeek(createTime.substring(0, 10));
	...
	private Map<String, Object> converToSimpleInfo(TevglActivitySigninInfo a){
		...
		// 计算创建日期处于星期几
		String val = DateUtil.getDayOfWeek(a.getCreateTime().substring(0, 10));
		info.put("dayOfWeek", val);
		return info;
	}
	...
	private List<String> getBrokenLineInfoxAxisArr(){
		List<String> dayList = DateUtil.getBeforeDays(14);
		return dayList;
	}
