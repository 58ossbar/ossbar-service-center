...
public class TevglTchRoomPereAnswerServiceImpl implements TevglTchRoomPereAnswerService {
	...
	public R save(@RequestBody(required = false) TevglTchRoomPereAnswer tevglTchRoomPereAnswer) throws OssbarException {
	...
	public R update(@RequestBody(required = false) TevglTchRoomPereAnswer tevglTchRoomPereAnswer) throws OssbarException {
	...
	public R deleteAnswerActivity(String activityId, String pkgId, String loginUserId) throws OssbarException {
