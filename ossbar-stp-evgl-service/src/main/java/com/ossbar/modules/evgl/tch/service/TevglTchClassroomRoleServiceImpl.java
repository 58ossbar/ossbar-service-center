...
import com.ossbar.modules.evgl.tch.api.TevglTchClassroomRoleService;
import com.ossbar.modules.evgl.tch.domain.TevglTchClassroomRole;
import com.ossbar.modules.evgl.tch.persistence.TevglTchClassroomRoleMapper;
...
@RestController
@RequestMapping("/tch/tevgltchclassroomrole")
public class TevglTchClassroomRoleServiceImpl implements TevglTchClassroomRoleService {
	...
	@GetMapping("/query")
	@SentinelResource("/tch/tevgltchclassroomrole/query")
	...
	@SentinelResource("/tch/tevgltchclassroomrole/queryForMap")
	...
	@SysLog(value="新增")
	@PostMapping("save")
	@SentinelResource("/tch/tevgltchclassroomrole/save")
	public R save(@RequestBody(required = false) TevglTchClassroomRole tevglTchClassroomRole) throws OssbarException {
	...
	@SysLog(value="修改")
	@PostMapping("update")
	@SentinelResource("/tch/tevgltchclassroomrole/update")
	public R update(@RequestBody(required = false) TevglTchClassroomRole tevglTchClassroomRole) throws OssbarException {
	    ValidatorUtils.check(tevglTchClassroomRole);
	...
	@SentinelResource("/tch/tevgltchclassroomrole/delete")
	...
	@SentinelResource("/tch/tevgltchclassroomrole/deleteBatch")
	...
	@SysLog(value="查看明细")
	@GetMapping("view/{id}")
	@SentinelResource("/tch/tevgltchclassroomrole/view")
