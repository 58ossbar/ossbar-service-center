...
import com.ossbar.modules.evgl.activity.api.TevglActivityTaskRelevanceGroupService;
...
@RestController
@RequestMapping("/activity/tevglactivitytaskrelevancegroup")
public class TevglActivityTaskRelevanceGroupServiceImpl implements TevglActivityTaskRelevanceGroupService {
	...
	@GetMapping("/query")
	@SentinelResource("/activity/tevglactivitytaskrelevancegroup/query")
	...
	@SentinelResource("/activity/tevglactivitytaskrelevancegroup/queryForMap")
	...
	@SysLog(value="新增")
	@PostMapping("save")
	@SentinelResource("/activity/tevglactivitytaskrelevancegroup/save")
	public R save(@RequestBody(required = false) TevglActivityTaskRelevanceGroup tevglActivityTaskRelevanceGroup) throws OssbarException {
	...
	@SysLog(value="修改")
	@PostMapping("update")
	@SentinelResource("/activity/tevglactivitytaskrelevancegroup/update")
	public R update(@RequestBody(required = false) TevglActivityTaskRelevanceGroup tevglActivityTaskRelevanceGroup) throws OssbarException {
	    ValidatorUtils.check(tevglActivityTaskRelevanceGroup);
	...
	@SentinelResource("/activity/tevglactivitytaskrelevancegroup/delete")
	...
	@SentinelResource("/activity/tevglactivitytaskrelevancegroup/deleteBatch")
	...
	@SysLog(value="查看明细")
	@GetMapping("view/{id}")
	@SentinelResource("/activity/tevglactivitytaskrelevancegroup/view")
