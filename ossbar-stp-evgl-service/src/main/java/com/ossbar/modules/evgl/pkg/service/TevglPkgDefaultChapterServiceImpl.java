...
public class TevglPkgDefaultChapterServiceImpl implements TevglPkgDefaultChapterService {
	...
	public R save(@RequestBody(required = false) TevglPkgDefaultChapter tevglPkgDefaultChapter) throws OssbarException {
	...
	public R update(@RequestBody(required = false) TevglPkgDefaultChapter tevglPkgDefaultChapter) throws OssbarException {
	    ValidatorUtils.check(tevglPkgDefaultChapter);
