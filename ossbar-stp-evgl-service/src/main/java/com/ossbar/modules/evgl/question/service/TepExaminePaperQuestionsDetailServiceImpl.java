...
@RestController
@RequestMapping("/question/tepexaminepaperquestionsdetail")
public class TepExaminePaperQuestionsDetailServiceImpl implements TepExaminePaperQuestionsDetailService {
	...
	@GetMapping("/query")
	@SentinelResource("/question/tepexaminepaperquestionsdetail/query")
	...
	@SentinelResource("/question/tepexaminepaperquestionsdetail/queryForMap")
	...
	@SysLog(value="新增")
	@PostMapping("save")
	@SentinelResource("/question/tepexaminepaperquestionsdetail/save")
	public R save(@RequestBody(required = false) TepExaminePaperQuestionsDetail tepExaminePaperQuestionsDetail) throws OssbarException {
	...
	@SysLog(value="修改")
	@PostMapping("update")
	@SentinelResource("/question/tepexaminepaperquestionsdetail/update")
	public R update(@RequestBody(required = false) TepExaminePaperQuestionsDetail tepExaminePaperQuestionsDetail) throws OssbarException {
	    ValidatorUtils.check(tepExaminePaperQuestionsDetail);
	...
	@SentinelResource("/question/tepexaminepaperquestionsdetail/delete")
	...
	@SentinelResource("/question/tepexaminepaperquestionsdetail/deleteBatch")
	...
	@SysLog(value="查看明细")
	@GetMapping("view/{id}")
	@SentinelResource("/question/tepexaminepaperquestionsdetail/view")
