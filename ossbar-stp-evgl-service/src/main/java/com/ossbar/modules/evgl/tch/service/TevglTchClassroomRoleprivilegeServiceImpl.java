...
public class TevglTchClassroomRoleprivilegeServiceImpl implements TevglTchClassroomRoleprivilegeService {
	...
	public R save(@RequestBody(required = false) TevglTchClassroomRoleprivilege tevglTchClassroomRoleprivilege) throws OssbarException {
	...
	public R update(@RequestBody(required = false) TevglTchClassroomRoleprivilege tevglTchClassroomRoleprivilege) throws OssbarException {
	    ValidatorUtils.check(tevglTchClassroomRoleprivilege);
