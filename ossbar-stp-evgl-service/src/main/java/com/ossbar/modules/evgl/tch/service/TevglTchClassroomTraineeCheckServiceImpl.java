...
public class TevglTchClassroomTraineeCheckServiceImpl implements TevglTchClassroomTraineeCheckService {
	...
	public R save(@RequestBody(required = false) TevglTchClassroomTraineeCheck tevglTchClassroomTraineeCheck) throws OssbarException {
	...
	public R update(@RequestBody(required = false) TevglTchClassroomTraineeCheck tevglTchClassroomTraineeCheck) throws OssbarException {
	    ValidatorUtils.check(tevglTchClassroomTraineeCheck);
	...
	public R setTraineeToClassroom(@RequestBody JSONObject jsonObject, String loginUserId) throws OssbarException {
