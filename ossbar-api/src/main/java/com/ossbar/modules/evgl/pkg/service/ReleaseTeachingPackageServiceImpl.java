...
public class ReleaseTeachingPackageServiceImpl implements ReleaseTeachingPackageService {
	...
	public R releaseTeachingPackage(JSONObject jsonObject, String loginUserId) {
		...
		List<TevglBookChapter> chapterListTree = tevglBookSubjectService.buildBook(subjectId, allChapterList, 0);
		...
		// 再保存新的教学包基本信息
		String newPkgId = doSavePkgInfo(jsonObject, subjectIdNew, loginUserId, privateUse, pkgInfo.getMajorId());
	 ...
	 * @return 返回新增后的教学包主键
	 */
	private String doSavePkgInfo(JSONObject jsonObject, String newSubjectId, String loginUserId, String privateUse, String majorId) {
