...
public class Swagger2Config {
	...
	public Docket innerApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2).groupName("innerApi")
				...
				//.apis(RequestHandlerSelectors.basePackage("com.creatorblue.modules.sys.service"))//这里采用包扫描的方式来确定要显示的接口
	...
	private ApiInfo innerApiInfo() {
		return new ApiInfoBuilder().title("创蓝基础平台").description("内部API：http://www.creatorblue.com")
				.termsOfServiceUrl("http://www.creatorblue.com").contact("湖南创蓝信息科技有限公司")
				.version("1.0").build();
	}
