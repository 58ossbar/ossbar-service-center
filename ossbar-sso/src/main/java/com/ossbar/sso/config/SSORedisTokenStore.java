 ...
 *
 */
public class SSORedisTokenStore implements TokenStore {
	...
	private static final int REFRESH_TOKEN_VALIDITY_SECONDS = 60*60*36;
	...
	public SSORedisTokenStore(RedisConnectionFactory connectionFactory) {
	...
	public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
		...
		try {
			...
			if (token.getExpiration() != null) {
				int seconds = ACCESS_TOKEN_VALIDITY_SECONDS;//token.getExpiresIn();
			...
			if (refreshToken != null && refreshToken.getValue() != null) {
				...
				if (refreshToken instanceof ExpiringOAuth2RefreshToken) {
					...
					if (expiration != null) {
						int seconds = REFRESH_TOKEN_VALIDITY_SECONDS;//Long.valueOf((expiration.getTime() - System.currentTimeMillis()) / 1000L).intValue();
